...
var AuthenticationService = /** @class */ (function () {
    function AuthenticationService(storage, pagesDataService) {
...
var FrameworkComponent = /** @class */ (function () {
    ...
    FrameworkComponent.ctorParameters = function () { return [
...
var HistoryService = /** @class */ (function () {
    function HistoryService(router) {
        ...
        this.router.events
            ...
            _this.urls = _this.urls.concat([url]);
        });
    }
...
var PageIterator = /** @class */ (function () {
    ...
    PageIterator.prototype.current = function () {
        return this.pages.getItems()[this.position];
    };
    PageIterator.prototype.selectedPageIndex = function () {
        return this.position;
    };
    PageIterator.prototype.next = function () {
        var item = this.pages.getItems()[this.position];
        this.position += 1;
        return item;
    };
    //vrati vyzadovanu stranu
    PageIterator.prototype.getPage = function (page) {
        var item = this.pages.getItems()[page];
        this.position = page;
        return item;
    };
    PageIterator.prototype.valid = function () {
        return this.position < this.pages.getCount();
    };
    PageIterator.prototype.getNumberPages = function () {
        return this.pages.getCount();
    };
    PageIterator.ctorParameters = function () { return [
        { type: PagesCollection }
    ]; };
    return PageIterator;
}());

var PagesCollection = /** @class */ (function () {
    function PagesCollection() {
        this.items = [];
    }
    PagesCollection.prototype.getItems = function () {
        return this.items;
    };
    PagesCollection.prototype.getCount = function () {
        return this.items.length;
    };
    PagesCollection.prototype.addItem = function (item) {
        this.items.push(item);
    };
    PagesCollection.prototype.getIterator = function () {
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(router, authenticationService, historyService) {
        this.router = router;
        this.authenticationService = authenticationService;
        this.historyService = historyService;
        this.formError = '';
    ...
    LoginComponent.prototype.doLogin = function () {
        ...
        this.authenticationService.login(this.credentials)
            .then(function () {
            _this.router.navigateByUrl(_this.historyService.getLastNonLoginUrl());
        })
            .catch(function (message) {
            _this.formError = message;
        });
    };
...
var CommentsComponent = /** @class */ (function () {
    function CommentsComponent(pagePanelDataService) {
        var _this = this;
        this.pagePanelDataService = pagePanelDataService;
        this.userComment = '';
        this.pagePanelDataService.pageChanged$.subscribe(function (page) {
            _this.page = page;
            _this.userComment = '';
            _this.commentsList = _this.page.getComments();
        });
    }
    CommentsComponent.prototype.ngOnInit = function () {
    };
    CommentsComponent.prototype.saveComment = function () {
        if (this.userComment) {
            ...
            var newComment = new _page__WEBPACK_IMPORTED_MODULE_2__["Comment"](window.turingUserId, this.userComment);
...
var OverviewComponent = /** @class */ (function () {
    function OverviewComponent(pagePanelDataService) {
        var _this = this;
        this.pagePanelDataService = pagePanelDataService;
        this.pagePosition = 1;
        this.pagePanelDataService.pageChanged$.subscribe(function (page) {
            _this.page = page;
            _this.pagePosition = page.pagePdfPosition + 1;
        });
    }
...
var PagePanelDataService = /** @class */ (function () {
    function PagePanelDataService() {
    }
    PagePanelDataService.prototype.setSubject = function (page) {
    ...
    PagePanelDataService.prototype.emitPage = function (changePage) {
        if (changePage) {
...
var PagePanelComponent = /** @class */ (function () {
    ...
    PagePanelComponent.prototype.ngOnInit = function () {
    };
    PagePanelComponent.prototype.formIsValid = function () {
    ...
    PagePanelComponent.prototype.resetAndHideRatingForm = function () {
        this.formVisible = false;
    ...
    //   }
    // }
    PagePanelComponent.prototype.isLoggedIn = function () {
        return !!window.turingUserId;
        //return this.authenticationService.isLoggedIn();
    };
    PagePanelComponent.prototype.getUsername = function () {
...
var Rating = /** @class */ (function () {
    ...
    Rating.prototype.addLike = function (userID) {
        var _this = this;
        //ak uz hodnotil
        if (this.getUserRating(userID)) {
            var user = this.getUserRating(userID);
            //ak hodnotil ako like odstrani hodnotenie
            if (user.ratedAs === "like") {
                this.usersRatedList = this.usersRatedList.filter(function (item) { return item !== _this.getUserRating(userID); });
                this.numLikes--;
                return false;
            }
        }
    ...
    Rating.prototype.addDislike = function (userID) {
        var _this = this;
        //ak uz hodnotil
        if (this.getUserRating(userID)) {
            var user = this.getUserRating(userID);
    ...
    Rating.prototype.getUserRating = function (userID) {
        return this.usersRatedList.find(function (x) { return x.userID == userID; });
    };
    Rating.prototype.canLike = function (userID) {
        var can = true;
        if (this.getUserRating(userID)) {
    ...
    Rating.prototype.canDislike = function (userID) {
        var can = true;
        if (this.getUserRating(userID)) {
...
var Page = /** @class */ (function () {
    ...
    Page.prototype.addComment = function (comment) {
...
var Comment = /** @class */ (function () {
    function Comment(userID, commentText) {
        this.userID = userID;
...
var PagesDataService = /** @class */ (function () {
    function PagesDataService(http, storage) {
        this.http = http;
        this.storage = storage;
        this.apiBaseUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].apiBaseUrl;
    }
    PagesDataService.prototype.getPageById = function (pageId) {
        var url = this.apiBaseUrl + "/pages/" + pageId;
        return this.http
            .get(url)
            .toPromise()
    ...
    PagesDataService.prototype.getPdfById = function (pdfId) {
        var url = this.apiBaseUrl + "/pdfs/" + pdfId;
        return this.http
            .get(url)
            .toPromise()
            .then(function (response) { return response; })
    ...
    PagesDataService.prototype.createPdf = function (pages) {
        var data = { numPages: pages };
        var url = this.apiBaseUrl + "/pdfs";
        return this.http
            .post(url, data)
            .toPromise()
            .then(function (response) { return response; })
    ...
    PagesDataService.prototype.handleError = function (error) {
        console.error('Something has gone wrong', error);
        return Promise.reject(error.message || error);
    };
    PagesDataService.prototype.addRatingByPdfPageId = function (pdfId, pageId, formData) {
        var url = this.apiBaseUrl + "/pdfs/" + pdfId + "/pages/" + pageId;
        var httpOptions = {
    ...
    PagesDataService.prototype.login = function (user) {
        return this.makeAuthApiCall('login', user);
    };
    PagesDataService.prototype.register = function (user) {
        return this.makeAuthApiCall('register', user);
    };
    PagesDataService.prototype.makeAuthApiCall = function (urlPath, user) {
    ...
    PagesDataService.ctorParameters = function () { return [
...
var PdfJsonDataService = /** @class */ (function () {
    function PdfJsonDataService() {
        this.jsonFile = pdfs_json__WEBPACK_IMPORTED_MODULE_4__;
    }
    PdfJsonDataService.prototype.findPdfInJson = function (filename) {
        var _this = this;
        var pdfs = JSON.stringify(this.jsonFile);
        var pdfsjson = JSON.parse(pdfs);
        var pdfFromFile = new _pdf__WEBPACK_IMPORTED_MODULE_2__["Pdf"];
        //najdenie pdf v Jsone
        pdfsjson.pdfs.forEach(function (pdf) {
            if (pdf._id === filename) {
                pdfFromFile = _this.loadPdfFromJson(pdf);
            }
        });
        return pdfFromFile;
    };
    PdfJsonDataService.prototype.loadPdfFromJson = function (jsonPdf) {
        var pdfFromJson = new _pdf__WEBPACK_IMPORTED_MODULE_2__["Pdf"]();
        pdfFromJson._id = jsonPdf._id;
        jsonPdf.pages.forEach(function (page, index) {
            var tmpPage = new _page__WEBPACK_IMPORTED_MODULE_3__["Page"](index);
            tmpPage.pdfId = page.pdfId;
            var tmpRating = new _page__WEBPACK_IMPORTED_MODULE_3__["Rating"]();
            tmpRating.numLikes = page.ratingDifficulty.numLikes;
            tmpRating.numDislikes = page.ratingDifficulty.numDislikes;
            var tmpUsersRatedList = [];
            page.ratingDifficulty.usersRatedList.forEach(function (rating, index) {
            ...
            var tmpRating2 = new _page__WEBPACK_IMPORTED_MODULE_3__["Rating"]();
            tmpRating2.numLikes = page.ratingQualtiy.numLikes;
            tmpRating2.numDislikes = page.ratingQualtiy.numDislikes;
            var tmpUsersRatedList2 = [];
            page.ratingQualtiy.usersRatedList.forEach(function (rating, index) {
            ...
            var tmpRating3 = new _page__WEBPACK_IMPORTED_MODULE_3__["Rating"]();
            tmpRating3.numLikes = page.ratingLook.numLikes;
            tmpRating3.numDislikes = page.ratingLook.numDislikes;
            var tmpUsersRatedList3 = [];
            page.ratingLook.usersRatedList.forEach(function (rating, index) {
            ...
            page.comments.forEach(function (comment, index) {
                var tmpComment = new _page__WEBPACK_IMPORTED_MODULE_3__["Comment"](comment.userID, comment.commentText);
    ...
    PdfJsonDataService.prototype.savePdfToJson = function (pdfJsonString) {
...
/* harmony import */ var _hhangular_pdfjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @hhangular/pdfjs */ "./node_modules/@hhangular/pdfjs/fesm5/hhangular-pdfjs.js");
...
var PdfPageViewComponent = /** @class */ (function () {
    function PdfPageViewComponent(route, 
    //private pagesDataService: PagesDataService,
    ...
    PdfPageViewComponent.prototype.ngOnInit = function () {
        var _this = this;
        window.turingUserId = "Tomas";
        var pdfFileName = "psi_03_manazment-poziadaviek.pdf";
        var pathToPdfsFolder = "assets/lectures/";
        ...
        this.pdfjsControl.load(pathToPdfsFolder + pdfFileName, true).then(function (numPages) {
            //ak sa pdf naslo v jsone, nacita ho
            if (_this.pdf.getPdfId()) {
                window.turingLectureId = _this.pdf.getPdfId();
                for (var i = 0; i < _this.pdf.pages.length; i++) {
                    var page = _this.pdf.pages[i];
                    if (page) {
                        _this.collection.addItem(page);
                    }
                }
                _this.page = _this.pageIterator.current();
                window.turingSlideId = _this.page._id;
                _this.pagePanelDataService.setSubject(_this.page);
            }
            else {
                _this.pdf.setPdfId(pdfFileName + "a");
                window.turingLectureId = _this.pdf.getPdfId();
                // //inicializacia iteratora
                _this.initialiseIterator(numPages, _this.pdf, function () {
                    _this.page = _this.pageIterator.current();
                    window.turingSlideId = _this.page._id;
                    _this.pagePanelDataService.setSubject(_this.page);
                ...
                _this.pdfJsonDataService.savePdfToJson(JSON.stringify(_this.pdf));
            }
        });
    ...
    PdfPageViewComponent.prototype.initialiseIterator = function (numPages, pdf, callback) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var i, page;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                for (i = 0; i <= numPages; i++) {
                    page = new _page__WEBPACK_IMPORTED_MODULE_1__["Page"](i);
                    if (page) {
    ...
    PdfPageViewComponent.prototype.onPageChange = function (newPage) {
        this.page = this.pageIterator.getPage(newPage);
        this.pagePanelDataService.emitPage(this.page);
    };
    PdfPageViewComponent.prototype.setPage = function (pageIndex) {
        this.page = this.pageIterator.getPage(pageIndex);
        this.pagePanelDataService.emitPage(this.page);
    };
    PdfPageViewComponent.ctorParameters = function () { return [
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _hhangular_pdfjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @hhangular/pdfjs */ "./node_modules/@hhangular/pdfjs/fesm5/hhangular-pdfjs.js");



var PdfViewerHhangularComponent = /** @class */ (function () {
    function PdfViewerHhangularComponent() {
    ...
    PdfViewerHhangularComponent.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.pdfjsControl.selectedIndex$.subscribe(function (number) {
            if (number !== undefined) {
                _this.changedPage.emit(number);
    ...
    PdfViewerHhangularComponent.prototype.scalePlus = function () {
        this.scalePercentage += 10;
        this.scale += 0.1;
    };
    PdfViewerHhangularComponent.prototype.scaleMinus = function () {
        this.scalePercentage -= 10;
        this.scale -= 0.1;
    };
    PdfViewerHhangularComponent.prototype.renderHandler = function ($event) {
        ...
        if ($event.type === _hhangular_pdfjs__WEBPACK_IMPORTED_MODULE_2__["RenderEventType"].START) {
            ...
            var time = $event.time - this.timeStart;
            var s = Math.trunc(time / 1000);
            var ms = time - s * 1000;
            console.log("Render " + $event.pages + " pages in " + s + "s " + ms + "ms");
        }
    };
    PdfViewerHhangularComponent.prototype.changePageHandler = function (event) {
    ...
    return PdfViewerHhangularComponent;
}());
...
var pdfjsLib = __webpack_require__(/*! pdfjs-dist/build/pdf */ "./node_modules/pdfjs-dist/build/pdf.js");
...
var PdfViewerComponent = /** @class */ (function () {
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.loadPDFDocument()];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
    ...
    PdfViewerComponent.prototype.loadPDFDocument = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4 /*yield*/, pdfjsLib.getDocument('./assets/test.pdf')];
                    case 1:
                        _a.pdf = _b.sent();
                        this.totalPages = this.pdf.numPages;
                        return [4 /*yield*/, this.generateView(this.pageNumber, this.canvas)];
                    case 2: return [2 /*return*/, _b.sent()];
                }
            });
        });
    };
    PdfViewerComponent.prototype.getCanvasElementById = function (id) {
    ...
    PdfViewerComponent.prototype.generateView = function (pageNumber, canvas) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var page, scale, viewport;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.pdf.getPage(pageNumber)];
                    case 1:
                        page = _a.sent();
                        scale = 1;
                        ...
                        return [4 /*yield*/, this.createRenderTask(page, canvas, viewport)];
                    case 2:
                        _a.sent();
    ...
    PdfViewerComponent.prototype.createRenderTask = function (page, canvas, viewport) {
    ...
    PdfViewerComponent.prototype.setDisplayValues = function (canvas) {
        this.imgWidth = canvas.width;
        this.imgHeight = canvas.height;
        this.imgSrc = canvas.toDataURL();
    };
    PdfViewerComponent.prototype.changePagePrevious = function () {
    ...
    PdfViewerComponent.prototype.changePageNext = function () {
        this.pageNumber = this.pageNumber + 1;
...
var Pdf = /** @class */ (function () {
    ...
    Pdf.prototype.setPdfId = function (pdfId) {
        this._id = pdfId;
    };
    Pdf.prototype.addPage = function (page) {
        this.pages.push(page);
    };
    Pdf.prototype.getPdfId = function () {
        return this._id;
    };
    return Pdf;
}());
...
var RatingLikesComponent = /** @class */ (function () {
    function RatingLikesComponent() {
        this.userId = window.turingUserId;
        this.actionLike = "+";
        this.actionDislike = "+";
    }
    RatingLikesComponent.prototype.ngOnInit = function () {
    ...
    RatingLikesComponent.prototype.likeClicked = function () {
    ...
    RatingLikesComponent.prototype.disLikeClicked = function () {
...
/* harmony import */ var _hhangular_pdfjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @hhangular/pdfjs */ "./node_modules/@hhangular/pdfjs/fesm5/hhangular-pdfjs.js");
